...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Node JS Backend Development",
      LEADCF123:
        "https://d2ms8rpfqc4h24.cloudfront.net/Node_js_for_Backend_Development_212e42f3bc.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Node JS Backend Development",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/Node_js_for_Backend_Development_212e42f3bc.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "node-js-backend-development" },
            });
          }
        }
      } catch (error) {
