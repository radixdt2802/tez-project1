              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                    <!-- <tez-link to="" title="Software Engineering"> -->
                      <span class="submenuName">Software Engineering</span>
                    <!-- </tez-link> -->
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                    <!-- <tez-link to="/"> -->
                      <span class="submenuName">Product Engineering</span>
                    <!-- </tez-link> -->
                  ...
                  >
                    <div
                      ...
                      @click="showSubmenu('isServices')"
                    >
                    <tez-link to="/hire-devops-engineer" title="DevOps Engineers">
                      <span class="submenuName">DevOps Engineers</span>
                    </tez-link>
                      
                    </div>
                  </div>
                  <!-- DevOps EngineersMenu End -->
                </nav>
              </div>
            </transition>
          </div>
                ...
                <nav class="lg:justify-center flex navMain lg:items-center">
                  <div class="dropdownHeading inline-block">
                    <button
                      ...
                      "
                    >
                    <!-- <tez-link to="/" title="Software Engineering" class="no-underline"> -->
                  ...
                  <div class="dropdownHeading inline-block">
                    <button
                      ...
                      "
                    >
                    <!-- <tez-link to="/" title="Product Engineering" class="no-underline"> -->
                      <span class="mr-1 whitespace-nowrap"
                  ...
                  <div class="dropdownHeading inline-block">
                    <button
                      ...
                      "
                    >
                    <tez-link to="/hire-devops-engineer" title="DevOps Engineers" class="no-underline">
                      <span class="mr-1 whitespace-nowrap"
                        >DevOps Engineers</span
                      >
                    </tez-link>
                    </button>
                  </div>
