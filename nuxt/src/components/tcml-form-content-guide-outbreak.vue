...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Software Development AMID COVID-19",
      LEADCF123:
        "https://d2ms8rpfqc4h24.cloudfront.net/Software_Development_AMID_COVID_19_b9e057fedd.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Software Development AMID COVID-19",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/Software_Development_AMID_COVID_19_b9e057fedd.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "Software-Development-AMID-COVID-19" },
            });
          }
        }
      } catch (error) {
