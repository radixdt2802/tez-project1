...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "A CTO’s Handbook on Application Modernization: The Why and How",
      LEADCF123:
        "https://s3.ap-south-1.amazonaws.com/stage.radixweb.com/Application_Modernization_Decision_new_f4d1e3f5c9.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "A CTO’s Handbook on Application Modernization: The Why and How",
      LEADCF125:
        "https://s3.ap-south-1.amazonaws.com/stage.radixweb.com/Application_Modernization_Decision_new_f4d1e3f5c9.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "application-modernization-guide-for-decision-makers" },
            });
          }
        }
      } catch (error) {
