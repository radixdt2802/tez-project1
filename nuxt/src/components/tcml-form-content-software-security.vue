...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Embracing Software Security Factors with Dedicated Developers",
      LEADCF123:
        "https://d2ms8rpfqc4h24.cloudfront.net/Top_Security_Factors_to_Consider_Before_You_Hire_Dedicated_Developers_2_0adb00a2d8.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Embracing Software Security Factors with Dedicated Developers",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/Top_Security_Factors_to_Consider_Before_You_Hire_Dedicated_Developers_2_0adb00a2d8.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "secure-software-development" },
            });
          }
        }
      } catch (error) {
