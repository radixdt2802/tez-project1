...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Remote Software Development",
      LEADCF123:
        "https://d2ms8rpfqc4h24.cloudfront.net/Remote_Software_Development_33b7e35c53.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Remote Software Development",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/Remote_Software_Development_33b7e35c53.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "Remote-Software-Development" },
            });
          }
        }
      } catch (error) {
