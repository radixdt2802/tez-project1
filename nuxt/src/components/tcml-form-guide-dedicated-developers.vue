...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Start Planning and Executing Your Project with Expert Devs",
      LEADCF123:
        "https://d2ms8rpfqc4h24.cloudfront.net/hire_dedicated_developers_with_links1_1_f6968c50bc.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Start Planning and Executing Your Project with Expert Devs",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/hire_dedicated_developers_with_links1_1_f6968c50bc.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "dedicated-developer-outsourcing-models" },
            });
          }
        }
      } catch (error) {
