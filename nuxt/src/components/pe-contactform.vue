<template>
  <div
    class="rxsection-y-space pe-contactform"
    v-bind:style="[
      data.Image ? { backgroundImage: 'url(' + data.Image.url + ')' } : '',
    ]"
  >
    <div class="container">
      <div class="form-block bg-opacitybg-65 dark:bg-themedark-65">
    ...
    .form-block {
      ...
      .form_row {
        ...
        option {
          ...
          color: #757575;
          height: 2.8125rem;
          @apply bg-themelight-0 rounded-lg py-3 px-4 text-sm w-full leading-5;
        }
        textarea {
          min-height: 7.125rem;
        }
