...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Build Better, Faster Software with Experts",
      LEADCF123:
        "https://s3.ap-south-1.amazonaws.com/stage.radixweb.com/Custom_Software_Solution_2_link_837bfd7af7.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Build Better, Faster Software with Experts",
      LEADCF125:
        "https://s3.ap-south-1.amazonaws.com/stage.radixweb.com/Custom_Software_Solution_2_link_837bfd7af7.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "custom-software-development-for-ctos" },
            });
          }
        }
      } catch (error) {
