      ...
      <div class="md:row md:flex md:flex-wrap">
        <div class="w-full md:px-4 md:w-8/12">
          <div class="p-4 careerDtl_left CareerForm">
            <h2 class="pb-0 break-words">{{ JobTitle }}</h2>
            <div
              class="py-4 font-bold text-center text-red-800 border border-red-800 dark:text-white dark:border-white"
            ...
            >
              ...
              <input
                ...
                style="display: none"
                name="returnURL"
                :value='"https&#x3a;&#x2f;&#x2f;radixweb.com&#x2f;careerform-thank-you?ref=" + `${data.GuideURL}`'
              />
              <!-- Do not remove this code. -->
        ...
        <div class="w-full md:px-4 md:w-4/12 md:relative">
          <div
            class="relative careerDtl_right md:absolute md:h-full md:overflow-y-auto"
          >
...
export default {
  ...
  async created() {
    try {
      ...
      let job_code = this.getQueryParam("job_code");
      let emailid = this.getQueryParam("emailid");
      let subject = this.getQueryParam("subject");
      ...
      try {
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              path: "/careerform-thank-you",query:{ref:this.data.GuideURL},
            });
          }
        }
      } catch (error) {
