...
export default {
  ...
  data() {
    return {
      ...
      te: "true",
      LEADCF122: "Mobile App Development Decision Guide for CTOs",
      LEADCF123:
        "https://d2ms8rpfqc4h24.cloudfront.net/Mobile_App_Development_65e7a4bd5f.pdf",
      LEADCF2: "White Paper",
      LEADCF4: "",
      LEADCF7: "",
      LEADCF8: "",
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Mobile App Development Decision Guide for CTOs",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/Mobile_App_Development_65e7a4bd5f.pdf",
      LEADCF11: "",
      LEADCF12: "",
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            self.$tezRouter.push({
              ...
              query: { guide: "mobile-app-development-decisions-ctos" },
            });
          }
        }
      } catch (error) {
