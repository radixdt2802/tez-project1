  ...
  <div class="relative form-content y-space-60 rxsection-b-space">
    <div class="container">
      <div class="row">
        ...
        >
          <div
            class="circle_list primary_list list_sm noBs customHeight"
            v-if="item.LongText"
          ...
          <div class="mt-4 flex flex-wrap">
            ...
            <img
                  ...
                  class="w-32 max-w-full p-4 md:p-0 md:px-4"
                />
              <!-- <span class="w-12 text-center hidden md:block " v-if="items.id != 4811">Vs</span> -->
            </div>
          </div>
        </div>
        <div class="flex-initial w-full mx-auto px-4 smd:w-auto">
...
export default {
  ...
  data() {
    return {
      ...
      LEADCF9: "",
      LEADCF10: "",
      LEADCF124: "Flutter Approach Whitepaper",
      LEADCF125:
        "https://d2ms8rpfqc4h24.cloudfront.net/Flutter_Approach_Whitepaper_f4e4518916.pdf",
      LEADCF11: "",
      LEADCF12: "",
      ...
      try {
        ...
        if (status == "200") {
          if (response.data.search("history.back()") !== -1) {
            ...
            this.errorMessage = "";
            self.$tezRouter.push("/whitepapers-thankyou");
          }
        }
      } catch (error) {
