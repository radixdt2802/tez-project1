              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                    <!-- <tez-link to="" title="Service-Oriented Architecture (SOA)"> -->
                      <span class="submenuName">Service-Oriented Architecture (SOA)</span>
                    <!-- </tez-link> -->
                    </div>
                  </div>
                  <!-- SOA Menu End -->
                ...
                <nav class="lg:justify-center flex navMain lg:items-center">
                  <div class="dropdownHeading inline-block">
                    <button
                      ...
                      "
                    >
                    <!-- <tez-link to="/" title="Service-Oriented Architecture (SOA)" class="no-underline"> -->
                      <span class="mr-1 whitespace-nowrap"
                        >Service-Oriented Architecture (SOA)</span
                      >
                    <!-- </tez-link> -->
                    </button>
                  </div>
