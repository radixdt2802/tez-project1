<template>
  <div class="contactus-section contentWhite rxsection-y-space bg-bottom  bg-no-repeat bg-rxa-secondary" id="Contact" v-bind:style="[
        data.Image
    ...
    <div class="container">
      <div class="row items-center">
        <div
          class="smd:order-1 w-full px-4 smd:w-6/12 smd:mt-0 pb-8 smd:pb-0"
        >
          <div class="text-center testimonialContact mb-8">
            <div class="smd:t-space-60 customerSuccess_content">
              <div
                class="h3 text-center pb-0"
                v-if="data.VueReferenceCode != 'TC_Contact_Form'"
              >
                {{ data.Title }}
              </div>
              <div
                class="h3 customHeadingColor text-center pb-0"
                v-if="data.VueReferenceCode != 'TC_Contact_Form'"
              >
                {{ data.SubTitle }}
              </div>
          ...
          <div class="year-image">
            <img
              ...
              class="mx-auto max-w-custom"
            />
          </div>
        </div>
        <div class="order-none w-full smd:w-6/12 px-4 smd:order-1">
          <div class="formContact">
           <div class="h2 smd:pl-20 pb-0 text-center smd:text-left pt-8 h2Normal" v-if="data.LongText" v-rxhtml="data.LongText"></div>
            <div id="crmWebToEntityForm" class="radix-zoho smd:pl-20 smd:border-l smd:border-solid smd:border-customcolor-91">
                ...
                <div class="rdx-form row">
                  <div class="w-full px-4 form-group sm:w-1/2">
                    <input
                      ...
                      class="form-control bg-transparent text-white border-b boder-solid border-white w-full text-base leading-5 py-3 inline-block outline-none placeholder-customcolor-91"
                      placeholder="Name *"
                  ...
                  <div class="w-full px-4 form-group sm:w-1/2">
                    <select
                      placeholder="Country"
                      class= "bg-rxa-secondary border-b boder-solid border-white w-full text-base leading-5 py-3 inline-block outline-none"                      v-model.trim="LEADCF16"
                      @blur.native="v$.LEADCF16.$touch()"
                    >
                      <option value disabled selected hidden class="text-customcolor-91">-Country-</option>
                  ...
                  <div class="w-full px-4 form-group">
                   ...
                   <div v-if="data.GuideURL" class='zcwf_row hidden'>
                    <div class='zcwf_col_lab' style='font-size:12px; font-family: Arial;'>
                      <label for='LEADCF11'>UTM Content</label>
                      </div>
                      <div class='zcwf_col_fld'>
                        <div id='LEADCF11' name='LEADCF11' maxlength='255'>{{data.GuideURL}}</div>
                  ...
                  <div class="w-full px-4 mb-0">
                    <div
                      ...
                      class="text-red-800 dark:text-white text-center border border-red-800 dark:border-white font-bold py-4 my-2"
                    >
                      {{ errorMessage }}
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      actionType: "TGVhZHM=",
      returnURL: "http&#x3a;//radixweb.com/thankyou?"+this.data.GuideURL,
      ldeskuid: "",
...
@layer utilities {
  .contactus-section {
    .customerSuccess_content {
      ...
      div.customHeadingColor{
        color: #4ef1e0 !important;
      }
    }
    .square_list {
      ul {
    ...
    .formContact {
      ...
      button[type="submit"].rxa_btn {
        // @apply sm:text-2xl sm:leading-8 text-xl leading-7 border border-primary bg-red-500 text-black rounded-xl px-16 py-3 transition-all ease-in-out duration-75 inline-block sm:w-auto w-full cursor-pointer;
         @apply inline-block;
      
          @apply text-xl font-poppins font-semibold py-0 px-4 leading-10 bg-rxa-primary border-rxa-primary flex items-center;
          &:hover {
            @apply bg-white text-black border-rxa-primary;
          }
          &::after {
            content: url("https://d2ms8rpfqc4h24.cloudfront.net/button_arrow_befaf3b20a.svg");
            line-height: 1;
            margin-left: 0.75rem;
