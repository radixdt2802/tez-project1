...
workbox.routing.registerRoute(new RegExp("^https://d2ms8rpfqc4h24.cloudfront.net/"), new workbox.strategies.CacheFirst({ cacheName: "assets-cache", cacheableResponse: { statuses: [0, 200] } }));
...
const cacheFirstStrategy = async (request) => {
    ...
    } else if (!hashKey) cacheResponse = await deleteCache(request);
